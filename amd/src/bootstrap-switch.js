 ...
 * DMB 23/02/16 wrapped for AMD loading
 * ========================================================================
  ...
  (function($, window) {
    ...
    BootstrapSwitch = (function() {
      function BootstrapSwitch(element, options) {
        ...
        // DMB 25/11/15 added as onchange not firing on the real checkbox otherwise
        this.$element.on('switchChange.bootstrapSwitch',function(event,state){
            $(this).trigger('change');
        });
      }
